...
<body class="bg-gray-100 text-gray-900">
  <div class="max-w-2xl mx-auto p-6">
    ...
    <!-- ボタンはフォーム外に置き、form属性で紐付け -->
    <div class="flex justify-end gap-4 mt-6">
      <button type="submit" form="deleteForm" class="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700">
        削除
      </button>
      <button type="submit" form="updateForm" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">
        更新
      </button>
    </div>
  </div>
